...
final class zzeo implements zziq {
    ...
    private zzeo(zzel zzel) {
        zzel zzel2 = (zzel) zzfh.zza((Object) zzel, "output");
        this.zza = zzel2;
        zzel2.zza = this;
    }
    ...
    public final void zzb(int i, Object obj, zzhf zzhf) throws IOException {
        zzel zzel = this.zza;
        zzel.zza(i, 3);
        zzhf.zza((Object) ((zzgm) obj), (zziq) zzel.zza);
        zzel.zza(i, 4);
    }
    ...
    public final <K, V> void zza(int i, zzgh<K, V> zzgh, Map<K, V> map) throws IOException {
        for (Map.Entry<K, V> entry : map.entrySet()) {
            this.zza.zza(i, 2);
            this.zza.zzb(zzge.zza(zzgh, entry.getKey(), entry.getValue()));
            zzge.zza(this.zza, zzgh, entry.getKey(), entry.getValue());
        }
    }
}
