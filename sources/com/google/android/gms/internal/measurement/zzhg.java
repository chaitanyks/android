...
public class zzhg<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: com.google.android.gms.internal.measurement.zzhg<K extends java.lang.Comparable<K>, V> */
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzhp remove = this.zzb.remove(i2 - 1);
