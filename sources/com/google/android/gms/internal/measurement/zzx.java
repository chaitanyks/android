...
public class zzx {
    ...
    private List<Pair<zzhi, zzb>> zzf;
    private int zzg;
    private boolean zzp;
    private String zzq;
    private zzm zzr;
    ...
    class zzd implements Application.ActivityLifecycleCallbacks {
        ...
        public final void onActivityCreated(Activity activity, Bundle bundle) {
            zzx.this.zza((zzx) new zzbc(this, activity, bundle));
        }

        public final void onActivityStarted(Activity activity) {
            zzx.this.zza((zzx) new zzbe(this, activity));
        }

        public final void onActivityResumed(Activity activity) {
            zzx.this.zza((zzx) new zzbd(this, activity));
        }

        public final void onActivityPaused(Activity activity) {
            zzx.this.zza((zzx) new zzbg(this, activity));
        }

        public final void onActivityStopped(Activity activity) {
            zzx.this.zza((zzx) new zzbf(this, activity));
        }

        public final void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
            zzk zzk = new zzk();
            zzx.this.zza((zzx) new zzbi(this, activity, zzk));
        ...
        public final void onActivityDestroyed(Activity activity) {
            zzx.this.zza((zzx) new zzbh(this, activity));
        }
    }
    ...
    public abstract class zza implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                zzx.this.zza((zzx) e, (Exception) false, this.zzc);
                zzb();
            }
        }
