...
public final class zzr extends zzu {
    ...
    public final boolean zza(Long l, Long l2, zzbs.zzc zzc, long j, zzaj zzaj, boolean z) {
        long j2;
        Boolean bool;
        boolean zzd = this.zzh.zzt().zzd(this.zza, zzap.zzbk);
        boolean zzd2 = this.zzh.zzt().zzd(this.zza, zzap.zzbl);
        Boolean bool2 = false;
        boolean z2 = zzkd.zzb() && this.zzh.zzt().zzd(this.zza, zzap.zzbv);
        if (!zzd2 || !zzd || !this.zzg.zzk()) {
            j2 = j;
        } else {
            j2 = zzaj.zze;
        }
        ...
        if (!z || z3) {
            ...
            Iterator<zzbk.zzc> it = zzb.zzd().iterator();
            while (true) {
                if (!it.hasNext()) {
                    ArrayMap arrayMap = new ArrayMap();
                    Iterator<zzbs.zze> it2 = zzc.zza().iterator();
                    while (true) {
                        if (!it2.hasNext()) {
                            Iterator<zzbk.zzc> it3 = zzb.zzd().iterator();
                            while (true) {
                                if (!it3.hasNext()) {
                                    bool2 = true;
                                    break;
                                }
                                zzbk.zzc next = it3.next();
