...
public final class zzfv {
    ...
    public final void zza(Context context, Intent intent) {
        zzgf zza2 = zzgf.zza(context, (zzv) null);
        zzfb zzr = zza2.zzr();
        if (intent == null) {
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            ...
            try {
                zza2.zzq().zza(new zzfy(this, zza2, zzr));
            } catch (Exception e) {
            ...
            zza2.zzq().zza(new zzfx(this, zza2, longExtra, zza3, context, zzr, doGoAsync));
        }
    }
}
