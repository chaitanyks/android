...
public class AnalyticsConnectorImpl implements AnalyticsConnector {
    ...
    public AnalyticsConnector.AnalyticsConnectorHandle registerAnalyticsConnectorListener(final String str, AnalyticsConnector.AnalyticsConnectorListener analyticsConnectorListener) {
        ...
        if ("fiam".equals(str)) {
            zza2 = new zze(appMeasurement, analyticsConnectorListener);
        } else if ("crash".equals(str)) {
            zza2 = new zzg(appMeasurement, analyticsConnectorListener);
        } else {
            zza2 = null;
        }
        if (zza2 == null) {
        ...
        return new AnalyticsConnector.AnalyticsConnectorHandle() {
            ...
            public void registerEventNames(Set<String> set) {
                if (AnalyticsConnectorImpl.this.zza((AnalyticsConnectorImpl) str) && str.equals("fiam") && set != null && !set.isEmpty()) {
            ...
            public void unregisterEventNames() {
                if (AnalyticsConnectorImpl.this.zza((AnalyticsConnectorImpl) str) && str.equals("fiam")) {
    ...
    public List<AnalyticsConnector.ConditionalUserProperty> getConditionalUserProperties(String str, String str2) {
        ...
        for (AppMeasurement.ConditionalUserProperty conditionalUserProperty : this.zzc.getConditionalUserProperties(str, str2)) {
            arrayList.add(zzb.zza(conditionalUserProperty));
        }
        return arrayList;
    }
