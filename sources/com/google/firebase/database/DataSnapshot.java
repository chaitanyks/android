...
public class DataSnapshot {
    ...
    public <T> T getValue(Class<T> valueType) {
        return (T) CustomClassMapper.convertToCustomClass(this.node.getNode().getValue(), valueType);
    }

    public <T> T getValue(GenericTypeIndicator<T> t) {
        return (T) CustomClassMapper.convertToCustomClass(this.node.getNode().getValue(), t);
    }
