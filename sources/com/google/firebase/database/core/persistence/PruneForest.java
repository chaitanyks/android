...
public class PruneForest {
    ...
    public <T> T foldKeptNodes(T startValue, final ImmutableTree.TreeVisitor<Void, T> treeVisitor) {
        return (T) this.pruneForest.fold(startValue, new ImmutableTree.TreeVisitor<Boolean, T>() {
            ...
            public T onNodeValue(Path relativePath, Boolean prune, T accum) {
                return !prune.booleanValue() ? (T) treeVisitor.onNodeValue(relativePath, null, accum) : accum;
            }
        });
    }
