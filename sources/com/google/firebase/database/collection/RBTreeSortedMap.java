...
public class RBTreeSortedMap<K, V> extends ImmutableSortedMap<K, V> {
    ...
    public ImmutableSortedMap<K, V> remove(K key) {
        ...
        return new RBTreeSortedMap(this.root.remove(key, this.comparator).copy(null, null, LLRBNode.Color.BLACK, null, null), this.comparator);
    }

    @Override // com.google.firebase.database.collection.ImmutableSortedMap
    public ImmutableSortedMap<K, V> insert(K key, V value) {
        return new RBTreeSortedMap(this.root.insert(key, value, this.comparator).copy(null, null, LLRBNode.Color.BLACK, null, null), this.comparator);
    }
    ...
    public K getPredecessorKey(K key) {
        ...
        throw new IllegalArgumentException("Couldn't find predecessor key of non-present key: " + ((Object) key));
    }
    ...
    public K getSuccessorKey(K key) {
        ...
        throw new IllegalArgumentException("Couldn't find successor key of non-present key: " + ((Object) key));
    }
    ...
    public static class Builder<A, B, C> {
        ...
        /* JADX INFO: Multiple debug info for r0v1 int: [D('half' int), D('key' A)] */
