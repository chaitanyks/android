...
public class PersistentConnectionImpl implements Connection.Delegate, PersistentConnection {
    ...
    private void onDataPush(String action, Map<String, Object> body) {
        ...
        if (action.equals("d") || action.equals("m")) {
            ...
            onListenRevoked(ConnectionUtils.stringToPath((String) body.get("p")));
    ...
    private void sendAuthHelper(final boolean restoreStateAfterComplete) {
        ...
        ConnectionRequestCallback onComplete = new ConnectionRequestCallback() {
            ...
            public void onResponse(Map<String, Object> response) {
                ...
                LogWrapper logWrapper = PersistentConnectionImpl.this.logger;
                logWrapper.debug("Authentication failed: " + status + " (" + ((String) response.get("d")) + ")", new Object[0]);
    ...
    private void sendPut(final long putId) {
        ...
        sendAction(action, put.getRequest(), new ConnectionRequestCallback() {
            ...
            public void onResponse(Map<String, Object> response) {
                ...
                if (((OutstandingPut) PersistentConnectionImpl.this.outstandingPuts.get(Long.valueOf(putId))) == put) {
