...
public class Toolbar extends ViewGroup {
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i2 = 0; i2 < leftViewsCount; i2++) {
            left4 = layoutChildLeft(this.mTempViews.get(i2), left4, collapsingMargins, alignmentHeight);
        }
        ...
        int i4 = 0;
        while (i4 < centerViewsCount) {
            centerLeft = layoutChildLeft(this.mTempViews.get(i4), centerLeft, collapsingMargins, alignmentHeight);
            i4++;
            left4 = left4;
        }
